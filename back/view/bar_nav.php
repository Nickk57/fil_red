<nav class="nav">
    <a class="nav-link" aria-current="page" href="index.php?page=2"><img src="images/Belleville-1024x519.png" alt="logo" width="50"></a>
    <a class="nav-link" href="index.php?page=2">gestion des category</a>
    <a class="nav-link" href="index.php?page=5">gestion des sous-category</a>
