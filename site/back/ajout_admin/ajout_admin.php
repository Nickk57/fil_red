    ...
    <div class="container-md text-center">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nom" class="form-control" id="exampleInputNom1" aria-describedby="Nom">
                <div id="Nom" class="form-text"></div>
            </div>
            <div class="mb-3">
                <label for="exampleInputprenom1" class="form-label">Votre prenom</label>
                <input type="text" name="prenom" class="form-control" id="exampleInputPrenom1" aria-describedby="prenom">
